...
const PostJobPage: FC<PostJobPageProps> = ({}) => {
  ...
  const form = useForm<z.infer<typeof jobForSchema>>({
    resolver: zodResolver(jobForSchema),
    defaultValues: {
      requiredSkills: [],
    },
  });

  const onSubmit = (val: z.infer<typeof jobForSchema>) => {
    console.log(val);
  };
    ...
    <div>
      ...
      <Form {...form}>
        ...
        >
          ...
          <FieldInput
            title="Salary"
            subtitle="please specify the estimated salart range for the role."
          >
          ...
          <FieldInput
            title="Nice-To-Haves"
            subtitle="Add nice-to-have skills and qualifications for the role to encorage a more diverse set of candidates to apply"
          >
            <CKEditor
              form={form}
              name="whoYouAre"
